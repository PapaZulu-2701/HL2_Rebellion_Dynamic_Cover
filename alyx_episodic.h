...
private:
	...
	enum
	{
		...
		COND_ALYX_HAS_HIGH_COVER, // [MODIFICATION-Dynamic Cover]
		COND_ALYX_HAS_LOW_COVER, // [MODIFICATION-Dynamic Cover]
	...
	enum 
	{
		...
		TASK_ALYX_MOVE_TO_HIGH_COVER,  // [MODIFICATION-Dynamic Cover]
		TASK_ALYX_MOVE_TO_LOW_COVER,  // [MODIFICATION-Dynamic Cover]
	};
